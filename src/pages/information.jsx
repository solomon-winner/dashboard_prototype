 ...
 const Information = () => {
   ...
   <div className="flex flex-col items-center justify-end gap-1 w-[400px] h-[55vh] font-sans" onClick={handleDivClick}>
    ...
    <div className="w-full h-auto flex justify-center max-w-full box-border">
            <div className="w-[30%] h-auto m-0 mx-1 bg-white">
                <div className="text-lg font-bold text-green-900 m-2 border-b border-green-900">
                    Join the Mission of Spreading God's Love
                </div>
                <div className="text-lg text-green-900 p-2">
                    Become a partner in sharing the gospel through music. Whether through prayer, financial support, or simply sharing the message, you can help spread the transformative power of worship to people around the world.
                </div>
            </div>
            <div className="w-[30%] h-auto m-0 mx-1 bg-white">
                <div className="text-lg font-bold text-green-900 m-2 border-b border-green-600">
                    Join the Mission of Spreading God's Love
                </div>
                <div className="text-lg text-green-900 p-2">
                    Become a partner in sharing the gospel through music. Whether through prayer, financial support, or simply sharing the message, you can help spread the transformative power of worship to people around the world.
      ...
      <div className="w-2/5 p-2 flex flex-col items-center justify-center text-green-900 font-sans h-[500px]">
        <h2>About</h2>
        <p>
